 ...
 * @author rodol
 */
public class PacoteSocialMediaUI extends javax.swing.JFrame {

    /**
     * Creates new form PacoteSocialMediaUI
     */
    public PacoteSocialMediaUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PacoteSocialMediaUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PacoteSocialMediaUI().setVisible(true);
            }
        });
    }
